    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="content" class="col-sm-9">
                <h1 class="title"><?php echo $brand->title?></h1>
                ...
                <div class="row products-category">
                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image"><a href="index.php?c=product&product=<?php echo $product->slug ?>"><img src="<?php echo $product->image ?>" alt="<?php echo $product->name ?>" title="<?php echo $product->name ?>" class="img-responsive" /></a></div>
                            <div>
                                <div class="caption">
                                    <h4><a href="index.php?c=product&product=<?php echo $product->slug ?>"> <?php echo $product->name ?> </a></h4>
                                    <p class="price">
                                        <?php
