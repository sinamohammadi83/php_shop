        ...
        <div class="col-12 col-sm-5">
            <form action="index.php?c=profile&a=profile" method="post">
                <?php if ($user->image): ?>
                    ...
                    <sapn id="upload-image"><img src="public/image/61-611898_camera-png-icon-camera-line-icon-png-clipart.png" width="40" alt=""></sapn>
                <?php endif; ?>
            ...
            <a href="index.php?c=profile&password" class="" >تغییر رمز عبور</a>
        </div>
    </div>
</div>
